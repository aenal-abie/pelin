                            ...
                            <table class = "table table-mailbox">
                                <thead>
                                    <tr class = "unread">                                            
                                        ...
                                        <th class = "subject"><a href = "#">Dosen</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    foreach ($groups as $group):
                                        ...
                                        <tr class = "unread">                                            
                                            ...
                                            <td class = "subject"><a href = "#"><?= $group->group->nama_group; ?></a></td>
                                            <td class = "subject"><a href = "<?= Yii::app()->createUrl('//peserta/profileDosen', ['id' => $group->group->user_id]) ?>"><?= $group->group->user->user->nama_lengkap; ?></a></td>
                                        </tr>
                                        <?php
                                    endforeach;
                                    ?>
